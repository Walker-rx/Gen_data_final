...
while(looptime < save_num)
    ...
    signal_ori_ini = [pilot_bpsk,zeros(1,zero_length),pilot_new,zeros(1,zero_length),data_mpam_ini_save];
    
    signal_ori = [pilot_bpsk,zeros(1,zero_length),pilot_new,zeros(1,zero_length),data_mpam];
